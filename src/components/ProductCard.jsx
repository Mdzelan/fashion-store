...
const ProductCard = ({ products }) => {
  ...
  return (
    <div className="border relative border-gray-200 rounded-2xl cursor-pointer overflow-hidden lg:w-[300px] lg:h-[300px] md:w-[300px] md:h-[300px]  w-[200px] h-[200px]
        hover:scale-105 hover:shadow-2xl transition-transform duration-300 bg-white/60 backdrop-blur-sm">
            {/* image section */}
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white/20 backdrop-blur-lg border-t border-white/30 p-3"  >
